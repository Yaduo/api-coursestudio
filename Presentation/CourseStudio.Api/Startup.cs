...
namespace CourseStudio.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<GoogleOAuthConfigs>(Configuration.GetSection("GoogleOAuth"));
            services.Configure<FacebookOAuthConfigs>(Configuration.GetSection("FacebookOAuth"));
            ...
            services.AddAuthorization(options =>
            {
				...
				options.AddPolicy(ApplicationPolicies.Token.RequireBlacklist, policy => {
					policy.AddRequirements(new AccessTokenVerificationRequirement()).Build();
                });
